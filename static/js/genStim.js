...
generateStimSet = (set1,set2,numIntervalTrials)=>{
...
generateStimSetImage = (set1,set2,numIntervalTrials)=>{
console.log("inside generateStimSet")
	...
	for(var i = 0;i<numIntervalTrials-1;i++)
	{
		...
		{
			stimOption = possibleStimsToBeFiltered[j];
			if(stimOption.word!=selectedStim.word && stimOption.image!=selectedStim.image)
			{
				subsetStims.push(stimOption);
			}
		}
