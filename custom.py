...
#         db_session.add(user)
#         db_session.commit()
#         resp = {"workerId":workerId,"assignmentId":assignmentId,"bonusComputed": "success","pb":pbonus,"platform":PLATFORM}
#         #resp = {"workerId":workerId,"bonusComputed": "success", "pb":pbonus,"PLATFORM":PLATFORM,"assignmentId":assignmentId}
#         return jsonify(**resp)
#     except:
